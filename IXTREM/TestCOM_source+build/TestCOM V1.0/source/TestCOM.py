...
class GUI(ttk.Frame):
    def __init__(self, parent, name='TestCOM'):
        ...
        self.parent = parent
        self.parent.title("TestCOM V1.0")
        self.fname = ""
        self.fileObj = None
        self.data = []
        self.started = False
    ...
    def _process_serial(self):
        ...
        try:
            ...
            if self.started:
                ...
                # print('test')
                #                self._fillList(self.list, self.data ,self.i)
    ...
    def _createPanel(self, parent):
        ...
        # Create Labels	
        # self._createLabel(self.panel2, "TESTER 4 sensor data:")

        # Create Treeviews		
        # self.table1 = self._createTreeview(panel2)

        #        self.list = self._createList(self.panel2)
    ...
    def _createList(self, parent):
        # print('aaa')
        ListFrame = ttk.Frame(parent)
        self.List = ttk.Listbox(ListFrame, height=5)
        self.List.grid(in_=ListFrame, column=0, row=0, sticky=(N, W, S, E))

    def _fillList(self, data, index):
        data.insert('end', data % index)
