...
class AIMultipleChannel(Task):
    """This class is in charge of continous data acquisition from a DAQmx device"""

    def __init__(self, dev_name=None, ch_name=None, data_nb=100, rate=50000.0, minVal=-10.0, maxVal=10.0):
        Task.__init__(self)
        self.ch_nb = 0
        if dev_name is None:
            dev_name = "Dev1"
        ...
        try:
            ...
            DAQmxCreateAIVoltageChan(self.taskHandle, self.phys_chan, "", DAQmx_Val_Diff, minVal, maxVal,
