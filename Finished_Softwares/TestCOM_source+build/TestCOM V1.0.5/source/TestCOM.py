...
class GUI(ttk.Frame):
    def __init__(self, parent, name='TestCOM'):
        ...
        self.size = 0
        self.Combo_value = ''
        self.baudrate = ['110', '300', '600', '1200', '2400', '4800', '9600', '14400', '19200', '28800', '38400', '56000', '57600', '115200', '128000', '153600', '230400', '256000', '460800', '921600']		
            ...
            if str(self.portCOM)[0:3] == 'COM':
                try:
                    ...
                    try:
                        ...
                        self.ser = Serial(self.portCOM, int(self.baudrate), timeout = None, xonxoff = False, rtscts = False, dsrdtr = False)
